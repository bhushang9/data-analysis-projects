...
│
├── data/
│   ├── superstore_sales.csv              # Raw dataset (9,994 records)
│   ├── cleaned_salesdata.csv             # Cleaned dataset
│   └── sales.db                          # SQLite database
├── dashboards/
│   └── sales_dashboard.png               # Power BI dashboard screenshot
├── images/                               # Generated visualizations (7 charts)
├── notebooks/
│   ├── data_cleaning.ipynb               # Data cleaning & feature engineering
│   └── eda.ipynb                         # EDA, SQL queries & visualizations
├── sql/
│   └── business_queries.sql              # 13 standalone SQL business queries
├── src/
│   └── create_database.py                # Script to load CSV into SQLite
└── requirements.txt
```
